...
const amenities = [
  {
    ...
    title: "Fresh Linens",
    description: "Clean towels provided for every class",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Eucalyptus Towels",
    description: "Cold, eucalyptus-infused towels to cool down",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Complimentary post-workout protein shakes",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Individual shower suites with premium products",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description: "Dyson Supersonic dryers and styling tools",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Coffee Bar",
    description: "Specialty coffee bar for before or after class",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-px bg-divider">
          {amenities.map((amenity, i) => (
            <ScrollReveal key={amenity.title} delay={i * 0.05}>
              <div className="bg-background-secondary p-8 lg:p-10 group hover:bg-background-tertiary transition-colors duration-500">
